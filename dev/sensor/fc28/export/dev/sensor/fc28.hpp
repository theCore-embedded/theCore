...
public:
    ...
    static err get_moisture(auto sample, auto resolution, fc28_defs::moisture_type &moisture);
};
...
template<typename PowerPin>
err fc28<PowerPin>::get_moisture(auto sample, auto resolution, fc28_defs::moisture_type &moisture)
{
