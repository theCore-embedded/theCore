...
set(CC_PLATFORM_FLAGS "-fno-strict-aliasing -mcpu=cortex-m3 -mthumb \
    -fdata-sections -ffunction-sections")

set(CXX_PLATFORM_FLAGS "-fcheck-new -fno-exceptions -fno-rtti ${CC_PLATFORM_FLAGS}")

# TODO: move std and gdwarf flags out of toolchain into the core listfile itself
set(C_CXX_EXTRA_FLAGS "-gdwarf-2 ")
set(CC_EXTRA_FLAGS "-std=gnu99 ${C_CXX_EXTRA_FLAGS}")
set(CXX_EXTRA_FLAGS "-std=gnu++14 ${C_CXX_EXTRA_FLAGS}")
...
set(CMAKE_ASM-ATT_COMPILE_OBJECT
    "<CMAKE_ASM-ATT_COMPILER> -mcpu=cortex-m3 -Wa,--defsym -Wa,SPARK_INIT_STARTUP=1 \
    -o <OBJECT> <SOURCE>")
